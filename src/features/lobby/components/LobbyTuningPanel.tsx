...
export function LobbyTuningPanel({
  ...
  const downloadLayoutJson = useCallback(() => {
    ...
    a.href = url;
    a.download = "coffee2048-lobby-layout.json";
    a.rel = "noopener";
    ...
    flashHint(
      "coffee2048-lobby-layout.json 파일을 저장했어요. 그 파일을 채팅에 첨부하거나 내용을 붙여넣으면 됩니다.",
    );
  }, [flashHint, layout]);
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs leading-relaxed text-coffee-950/82">
              기준 좌표: reference 원본 {LOBBY_LAYOUT_BASE.width}×
              {LOBBY_LAYOUT_BASE.height}px
            </p>
          </div>
          <button
            type="button"
